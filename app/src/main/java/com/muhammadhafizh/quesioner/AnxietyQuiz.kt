...
class AnxietyQuiz : AppCompatActivity() {
    ...
    private fun processAnswer(answerView: TextView, selectedAnswer: String) {
        ...
        if (currentQuestions < questionsItems.size - 1) {
            ...
            val intent = Intent(this@AnxietyQuiz, ResultActivity::class.java)
    ...
    private fun loadAllQuestions() {
        ...
        val jsonquiz = loadJsonFromAsset("anxietyquestions.json")
        try {
            val jsonObject = JSONObject(jsonquiz)
            val questions = jsonObject.getJSONArray("anxietyquestions")
    ...
    override fun onBackPressed() {
        super.onBackPressed()
        MaterialAlertDialogBuilder(this@AnxietyQuiz)
            ...
            .setPositiveButton(android.R.string.yes) { _, _ ->
                startActivity(Intent(this@AnxietyQuiz, MainActivity::class.java))
                finish()
            }
            .show()
    }
